...
contract TokenFactory {
    ...
    function createProject(string memory name, string memory symbol, uint initialSupply, address beneficiary) public payable {
        require(msg.value >= 0.001 ether, "Pay 0.001 native token to deploy your contract");
